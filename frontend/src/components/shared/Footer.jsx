      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">HireNext Job Platform</h2>
            <p className="text-sm">Copyright © 2025 HireNext Job Platform  |  All Rights Reserved</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/ajinkya.chirde" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/ajinkya_chirde7" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/ajinkya-chirde/" className="hover:text-gray-400" aria-label="LinkedIn">
